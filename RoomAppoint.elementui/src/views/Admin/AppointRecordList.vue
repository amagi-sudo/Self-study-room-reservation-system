        ...
        <el-row :gutter="10" class="EditFromBody" style="  height: 600px;overflow-y: scroll">
          <el-col :span="24">
            <el-form-item label="流水编号" prop="No">
              <el-input type="text" v-model.trim="formData.No" placeholder="请输入流水编号" :clearable="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="手机号" prop="Phone">
              <el-input type="text" v-model.trim="formData.Phone" placeholder="请输入手机号" :clearable="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
            <el-form-item label="评论" prop="Comment">
              <el-input type="text" v-model.trim="formData.Comment" placeholder="请输入评论" :clearable="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
