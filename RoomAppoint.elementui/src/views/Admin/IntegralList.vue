  ...
  <div class="app-container">
      ...
      <div class="tb-body">
        <el-form ref="searchFormRef" :model="searchForm" :inline="true" label-width="120px" :style="`flex:1;`">
          ...
          <el-form-item label="关联号" prop="RelativeCodeLike">
            <el-input v-model.trim="searchForm.RelativeCodeLike" placeholder="请输入关联号" :clearable="true"></el-input>
          </el-form-item>
          <el-form-item label="用户">
            <SigleSelect url="/User/List" columnName="Name" :clearable="true" columnValue="Id"
              v-model="searchForm.UserId" :where="{ RoIeType: 2 }">
            </SigleSelect>
          </el-form-item>
        </el-form>
      </div>
        ...
        <el-row :gutter="10" class="EditFromBody">
          ...
          <el-col :span="24">
            <el-form-item label="用户" prop="UserId">
              <SigleSelect url="/User/List" :where="{ RoIeType: 2 }" columnName="Name" columnValue="Id"
          ...
          <el-col :span="24">
            <el-form-item label="来源" prop="Source">
              <el-input type="text" v-model.trim="formData.Source" placeholder="请输入来源" :clearable="true"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="24">
    ...
    <PaginationTable ref="PaginationTableId" url="/Integral/List" :column="dataColum" :where="where">
      <template v-slot:header>
        <el-button type="primary" size="mini" plain icon="el-icon-edit" @click="ShowEditModal()">积 分 调 整</el-button>
