    ...
    <div class="margin-top-lg Card">
      <el-form v-if="editorShow == true" ref="editModalForm" :rules="editModalFormRules" :model="formData"
        ...
        <el-row :gutter="10" class="EditFromBody">
          ...
          <el-col :span="24">
            <el-form-item label="座位" prop="SeatId">
              <SigleSelect url="/Seat/List" :disabled="true" columnName="No" columnValue="Id" v-model="formData.SeatId">
              </SigleSelect>
            </el-form-item>
          </el-col>
          <el-col :span="24">
          ...
          <el-col :span="24">
            <el-form-item label="预约时间" prop="AppointDateType">
              <SigleSelect url="/Select/AppointDateTypeEnum" :disabled="true" columnName="Name" columnValue="Code"
                v-model="formData.AppointDateType">
              </SigleSelect>
            </el-form-item>
          </el-col>
          <el-col :span="24">
        ...
        <el-row type="flex" justify="end" align="bottom">
          <el-form-item>
            <el-button type="primary" size="mini" @click="ToOrder()">确 定</el-button>
          </el-form-item>
        </el-row>
      </el-form>
    </div>
